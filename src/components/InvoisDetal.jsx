...
export default function InvoiceDetail({ invoice, onBack, onUpdateInvoice, darkMode, setDarkMode }) {
        ...
        {isEditing ? (
          ...
          <div className="flex justify-center">
            ...
            >
              ...
              <button className="bg-[#EC5757] text-white rounded-[20px] w-[100px] p-[10px] ml-[20px]">
                Delete
              </button>
          ...
          <div className="flex justify-center mt-[50px]">
            ...
            >
              ...
              <div className="space-y-4 text-sm font-medium">
                ...
                <p>
                  <span className="text-gray-500">Amount:</span> £{invoice.amount}
                </p>
              </div>
