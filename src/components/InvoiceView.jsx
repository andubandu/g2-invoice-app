...
function InvoiceView({ invoice, onEdit, onBack, onDelete }) {
  ...
  const formatCurrency = (amount) => {
    return (amount && !isNaN(amount)) ? amount.toFixed(2) : "556.00";
  };

  return (
    <div className="max-w-[730px] mx-auto relative">
      <button
        onClick={onBack}
      ...
      <div className="bg-white rounded-lg shadow-sm p-8">
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={openModal}
              className="px-6 py-4 text-white bg-[#EC5757] rounded-full font-bold hover:bg-[#FF9797] transition-colors"
            >
              Delete
            </button>
          ...
          <div className="grid grid-cols-3 gap-8 mb-12">
            <div>
              <div className="mb-8">
                ...
                <p className="text-[#0C0E16] font-bold">
